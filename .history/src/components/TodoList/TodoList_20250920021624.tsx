      ...
      <TitleRow>
        ...
        <div>
          <IconButton
            ...
            title="Сначала новые"
          >
            <ArrowUpwardIcon color={sortOrder === "new" ? "primary" : "inherit"} />
          </IconButton>
          <IconButton
          ...
          >
            <ArrowDownwardIcon color={sortOrder === "old" ? "primary" : "inherit"} />
          </IconButton>
        </div>
      </TitleRow>
      ...
      <InputRow>
        <div style={{ flex: 1 }}>
          <Input
            ...
            hasError={error}
          />
          {error && <ErrorText>Поле не может быть пустым</ErrorText>}
        </div>
